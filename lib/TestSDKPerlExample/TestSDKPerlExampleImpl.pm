package TestSDKPerlExample::TestSDKPerlExampleImpl;
use strict;
...
A KBase module: TestSDKPerlExample
...
sub new
{
    ...
    my $scratch = $cfg->val('TestSDKPerlExample', 'scratch');
...
<pre>
$params is a TestSDKPerlExample.FilterContigsParams
$output is a TestSDKPerlExample.FilterContigsResults
FilterContigsParams is a reference to a hash where the following keys are defined:
	assembly_input_ref has a value which is a TestSDKPerlExample.assembly_ref
...
FilterContigsResults is a reference to a hash where the following keys are defined:
	...
	assembly_output has a value which is a TestSDKPerlExample.assembly_ref
...
sub filter_contigs
{
    ...
    my $ctx = $TestSDKPerlExample::TestSDKPerlExampleServer::CallContext;
    my($output);
